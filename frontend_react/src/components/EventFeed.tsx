...
export const EventFeed: React.FC<EventFeedProps> = ({ logs }) => {
  return (
    <div className="glass-panel rounded-xl p-3 flex flex-col justify-between flex-1 min-h-0 overflow-hidden bg-[#060D1A]/90 border border-cyan-500/30 shadow-[0_0_20px_rgba(0,240,255,0.06)]">
      ...
      <div className="flex-1 overflow-y-auto mt-2 space-y-1.5 pr-1 text-xs font-code">
        {logs.map(log => {
          let borderCol = 'border-l-[#00F0FF] bg-slate-900/40';
